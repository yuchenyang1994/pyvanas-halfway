# encoding: utf-8
from vanas_td.vnctptd import *
from time import sleep

def print_dict(d):
    """按照键值打印一个字典"""
    for key,value in d.items():
        print key + ':' + str(value).decode('gbk')
...
class TestTdApi(TdApi):
    ...
    def onRspError(self, error, n, last):
        """错误"""
        print error['ErrorMsg'].decode('utf-8')
...
def main():
    ...
    # 登陆，测试通过
    loginReq = {}                           # 创建一个空字典
    loginReq['UserID'] = '069586'         # 参数作为字典键值的方式传入
    loginReq['Password'] = '940304'         # 键名和C++中的结构体成员名对应
